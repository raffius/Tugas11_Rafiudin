<?php
	...
	$sql = $koneksi->query("SELECT * from kasir");
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SI DATA PENJUALAN</span>
			</a>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              //Klik Halaman Home Barang
				...
				//Asrama
				case 'data-kasir':
					include "admin/kasir/data_kasir.php";
					break;
				case 'add-pegawai':
					include "admin/kasir/add_kasir.php";
					break;
				case 'edit-pegawai':
					include "admin/kasir/edit_kasir.php";
					break;
				case 'del-pegawai':
					include "admin/kasir/del_kasir.php";
					break;
				case 'view-pegawai':
					include "admin/kasir/view_kasir.php";
					break;
